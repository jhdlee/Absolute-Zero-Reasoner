#!/bin/bash
# Verification Experiment: Adaptive Mode
# Uses uncertainty (sc_entropy_normalized) to decide verification method
...
N_SAMPLES_UQ=${N_SAMPLES_UQ:-8}  # Samples for uncertainty estimation
...
python -m absolute_zero_reasoner.main_azr_ppo \
    ...
    trainer.project_name='verification_experiment' \
    trainer.experiment_name='adaptive_coder3b' \
